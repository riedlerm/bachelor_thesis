...
args = TrainingArguments(
    output_dir = path + "monotrans_EN_DE",
    seed = 42, 
...
if do_train:
    ...
    ## Extract token embedeings of transfer language (test_langauge)
    ...
    # target_model_checkpoint = 'Models/Monolingual/Training/training-DE-DE'
    # target_model_checkpoint = 'Models/MonoTrans/Training/monotrans_EN_DE'
    ...
    # replace word embeddings of finetuned model with transfer embeddings and evaluate on the test set
