...
tokenizer = BertTokenizer.from_pretrained(model_checkpoints[target_language], use_fast=True)
...
args = TrainingArguments(
    output_dir = path + "monotrans_finetuning_part1_" + source_language + "_" + target_language + "_tok_DE",
    seed = 42, 
