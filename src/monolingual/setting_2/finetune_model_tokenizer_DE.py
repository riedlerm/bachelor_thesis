...
if resume_training:
    ...
    model_checkpoint = model_checkpoints[language]



tokenizer = BertTokenizer.from_pretrained(model_checkpoints['de'], use_fast=True)
model = BertForSequenceClassification.from_pretrained(model_checkpoint, num_labels=num_labels)



print("=====================")
print("EMBEDDINGS BERT BASE UNCASED")
print("=====================")


# freezing token embeddings of source language
...
args = TrainingArguments(
    output_dir = path + "monotrans_finetuning_part2_" + language + "_tok_DE",
    seed = 42, 
