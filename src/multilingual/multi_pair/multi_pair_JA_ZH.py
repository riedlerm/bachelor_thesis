...
dataset = dataset.filter(lambda example : example['language'] in train_languages)
...
if do_shard:
    ...
    test_dataset = dataset['test'].shard(index=1, num_shards=20)
else:
...
if do_train:
    ...
    model_checkpoint = 'Models/Multilingual/Training/multi_pair_JA_ZH'
    print('=====================')
...
args = TrainingArguments(
    output_dir = f'{path}{filename}_{train_languages[0]}_{train_languages[1]}',
    seed = 13, 
